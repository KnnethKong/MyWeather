 ...
 * 天气折线图
 */
public class WetherZhe extends View {
    private int XPoint = 60;//原点X/Y
    private int YPoint = 260;
    private int XScale = 8;  //X/Y刻度长度
...
//                MyView.this.invalidate();
    ...
    public WetherZhe(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public WetherZhe(Context context) {
        super(context);
    }

    public WetherZhe(Context context, AttributeSet attrs) {
        super(context, attrs);
